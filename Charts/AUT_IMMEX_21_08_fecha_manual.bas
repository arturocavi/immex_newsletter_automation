Attribute VB_Name = "AUT_IMMEX_21_08"
' Variables globales
Global Grafica_man
Global Grafica_nom
Global Grafica_acu
...
plantilla = "C:\Users\arturo.carrillo\Documents\IMMEX\AUT\Plantilla IMMEX.dotx" ' UBICACIÓN PERSONAL
...
documento.Paragraphs(9).Range.InsertBreak Type:=7 'wdSectionBreakNextPage
documento.Content.insertparagraphafter
...
documento.Paragraphs(13).Range.Paste
documento.Content.insertparagraphafter
...
' Insertar salto de página
documento.Paragraphs(35).Range.InsertBreak Type:=7
documento.Content.insertparagraphafter
...
documento.Paragraphs(40).Range.Paste
documento.Content.insertparagraphafter
...
With documento.Paragraphs(42).Range
    .Bold = False
    .Font.Size = 10
    .ParagraphFormat.Alignment = 3
End With
...
' Insertar salto de página
documento.Paragraphs(43).Range.InsertBreak Type:=7
documento.Content.insertparagraphafter
...
documento.Paragraphs(47).Range.Paste
documento.Content.insertparagraphafter
...
' Insertar salto de página
documento.Paragraphs(49).Range.InsertBreak Type:=7
documento.Content.insertparagraphafter
...
With documento.Paragraphs(52).Range
    .Bold = True
    .Font.Size = 12
    .ParagraphFormat.Alignment = 1
    .ParagraphFormat.SpaceBefore = 0
...
documento.Paragraphs(53).Range.Paste
documento.Content.insertparagraphafter
